...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-pond-c22e
```

A live public deployment of this template is available at [https://shy-pond-c22e.templates.workers.dev](https://shy-pond-c22e.templates.workers.dev)
